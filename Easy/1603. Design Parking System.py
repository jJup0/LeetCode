class ParkingSystem:
    ...
    Implement the ParkingSystem class:
        ...
        bool addCar(int carType) Checks whether there is a parking space of carType
            for the car that wants to get into the parking lot. carType can be of
            three kinds: big, medium, or small, which are represented by 1, 2, and 3
    ...
    def __init__(self, big: int, medium: int, small: int):
        self.slots_left = [0, big, medium, small]

    def addCar(self, carType: int) -> bool:
        self.slots_left[carType] -= 1
        return self.slots_left[carType] >= 0
