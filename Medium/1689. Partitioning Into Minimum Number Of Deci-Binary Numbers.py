class Solution:
    ...
    def minPartitions(self, n: str) -> int:
        # number of deci-binary numbers needed is equal to highest digit
        # string is an iterable, so find max digit in it, and convert to int
        return int(max(n))

    # # somehow this garbage is faster in the leetcode tests:
